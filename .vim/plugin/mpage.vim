...
" GetLatestVimScripts: 4545 1 :AutoInstall: mpage.vim
...
"  call Dfunc("s:MpageDown()")
  ...
  let curwin= winnr()
  noautocmd windo if exists("w:mpage")|norm! zR|if !exists("firstwin")|let firstwin=winnr()|endif|let lastline= line("w$")|endif
  exe curwin."wincmd w"
...
"  call Dfunc("s:MpageUp()")
  ...
  let curwin= winnr()
  noautocmd windo if exists("w:mpage")|norm! zR|if !exists("firstline")|let firstline= line("w0")|let firstwin=winnr()|endif|let lastline= line("w$")|endif
  exe curwin."wincmd w"
